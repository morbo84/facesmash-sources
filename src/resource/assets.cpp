...
void loadResources(GameRenderer &renderer) {
    ...
    ttfFontCache.load<TTFFontLoader>("font/ui/huge", "font/04B_03__.ttf", 116);
...
void prepareGameStrings(GameRenderer &renderer) {
    ...
    textureCache.load<TTFFontTextureLoader>("str/0", "0", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/1", "1", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/2", "2", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/3", "3", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/4", "4", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/5", "5", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/6", "6", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/7", "7", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/8", "8", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/9", "9", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/ ", " ", renderer, *fontTiny, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/.", ".", renderer, *fontTiny, colorWhite);

    textureCache.load<TTFFontTextureLoader>("str/score", "SCORE", renderer, *fontTiny, colorRed);
    textureCache.load<TTFFontTextureLoader>("str/timer", "TIME", renderer, *fontTiny, colorRed);
    ...
    textureCache.load<TTFFontTextureLoader>("str/credits", "CREDITS", renderer, *fontLarge, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/support", "SUPPORT US", renderer, *fontLarge, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/settings", "SETTINGS", renderer, *fontLarge, colorWhite);
    textureCache.load<TTFFontTextureLoader>("str/achievements", "ACHIEVEMENTS", renderer, *fontLarge, colorWhite);
    ...
    textureCache.load<TTFFontTextureLoader>("str/reward/perfect", "PERFECT", renderer, *fontNormal, colorGreen);
