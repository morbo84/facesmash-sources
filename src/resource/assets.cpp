...
void loadCameraFrame(GameRenderer &renderer) {
    ...
    Locator::TextureCache::ref().load<SDLTextureLoader>("camera/frame", renderer, cameraFormat, SDL_TEXTUREACCESS_STREAMING, cameraService.width(), cameraService.height());
}
